...
duOPcreate(CLUREF common, CLUREF *ret_1)
{
  ...
  LINE(35);
    ...
    if ((duOPstore.array->int_low + duOPstore.array->ext_size + 1) < duOPstore.array->int_size) {
        ...
        duOPstore.array->ext_size++;
        duOPstore.array->ext_high++;
    }
    else {
  ...
  LINE(36);
    ...
    if ((duOPfixups.array->int_low + duOPfixups.array->ext_size + 1) < duOPfixups.array->int_size) {
        ...
        duOPfixups.array->ext_size++;
        duOPfixups.array->ext_high++;
    }
    else {
  ...
  LINE(37);
    ...
    if ((duOPcache.array->int_low + duOPcache.array->ext_size + 1) < duOPcache.array->int_size) {
        ...
        duOPcache.array->ext_size++;
        duOPcache.array->ext_high++;
    }
    else {
...
duOPget_dump_info(CLUREF d, CLUREF *ret_1, CLUREF *ret_2)
{
  ...
  LINE(76);
    ...
    T_1_4.num = (T_1_3.num > duOPkeepmax.num);
    ret_2->num = T_1_4.num;
    }
    signal (ERR_ok);
    }
...
duOPforget_specs(CLUREF d)
{
  ...
  LINE(93);
    ...
    CLUREF T_1_2;
    T_1_1.num = d.vec->data[0];
    T_1_2.num = (T_1_1.num > duOPkeepmax.num);
