...
struct OPS *record_id_type__ops __CLU_COMMON;
static int typespec_own_init = 0;
const OWN_req typespec_ownreqs = { 0, 0 };

errcode
typespec_own_init_proc(void)
{
    errcode err;
    enter_own_init_proc();
    if (typespec_own_init == 0) {
        ...
        add_selector_info("id", 0, (struct OPS *)int_ops);
        add_selector_info("type_", 1, (struct OPS *)oneof_any__apply_cluster__cvt__idn_other_select_type__unknown_xclu_xsel_ops);
...
typespecOPmismatch(CLUREF t1, CLUREF t2, CLUREF *ret_1)
{
  ...
  LINE(107);
            ...
            T_3_12.num = !T_3_1.num;
            if (T_3_12.num == true) { /* if */
...
static CLU_proc typespec_oe__gcd = { .proc = typespecOP_gcd };
static CLU_proc typespec_oe_copy = { .proc = typespecOPcopy };
static CLU_proc typespec_oe_create = { .proc = typespecOPcreate };
static CLU_proc typespec_oe_equal = { .proc = typespecOPequal };
static CLU_proc typespec_oe_get_abs = { .proc = typespecOPget_abs };
static CLU_proc typespec_oe_get_id = { .proc = typespecOPget_id };
static CLU_proc typespec_oe_is_unknown = { .proc = typespecOPis_unknown };
static CLU_proc typespec_oe_mismatch = { .proc = typespecOPmismatch };
static CLU_proc typespec_oe_mismatch2 = { .proc = typespecOPmismatch2 };
static CLU_proc typespec_oe_set_abs = { .proc = typespecOPset_abs };
static CLU_proc typespec_oe_set_id = { .proc = typespecOPset_id };
static CLU_proc typespec_oe_similar = { .proc = typespecOPsimilar };

static typespec_OPS typespec_ops_actual = {12, (OWNPTR)&typespec_own_init, (OWNPTR)&typespec_own_init, {
...
struct OPS *oneof_du_expr_typeset_ops __CLU_COMMON;
extern struct OPS *oneof_du_expr_typeset_ops;
struct OPS *record_idn_line_val_ops __CLU_COMMON;
static CLUREF STR_REP;
static int equate_own_init = 0;
const OWN_req equate_ownreqs = { 0, 0 };

errcode
equate_own_init_proc(void)
{
    errcode err;
    enter_own_init_proc();
    if (equate_own_init == 0) {
        ...
        add_selector_info("du", 0, (struct OPS *)string_ops);
        add_selector_info("expr", 1, (struct OPS *)expr_ops);
        add_selector_info("typeset", 2, (struct OPS *)record_equates_idn_ops_ops);
        find_selector_ops("oneof", 3, &(oneof_du_expr_typeset_ops));
        add_selector_info("idn", 0, (struct OPS *)idn_ops);
        add_selector_info("line", 1, (struct OPS *)int_ops);
        add_selector_info("val", 2, (struct OPS *)oneof_du_expr_typeset_ops);
...
equateOPis_rep(CLUREF e, CLUREF *ret_1)
{
  ...
  LINE(176);
    ...
    T_1_3.num = ((STR_REP.str->size != T_1_2.str->size)? false :
        !(memcmp(STR_REP.str->data, T_1_2.str->data, STR_REP.str->size)));
    ret_1->num = T_1_3.num;
    }
    signal (ERR_ok);
    }
...
static CLU_proc equate_oe__gcd = { .proc = equateOP_gcd };
static CLU_proc equate_oe_copy = { .proc = equateOPcopy };
static CLU_proc equate_oe_create = { .proc = equateOPcreate };
static CLU_proc equate_oe_equal = { .proc = equateOPequal };
static CLU_proc equate_oe_get_idn = { .proc = equateOPget_idn };
static CLU_proc equate_oe_get_line = { .proc = equateOPget_line };
static CLU_proc equate_oe_get_val = { .proc = equateOPget_val };
static CLU_proc equate_oe_is_rep = { .proc = equateOPis_rep };
static CLU_proc equate_oe_similar = { .proc = equateOPsimilar };

static equate_OPS equate_ops_actual = {9, (OWNPTR)&equate_own_init, (OWNPTR)&equate_own_init, {
    {&equate_oe__gcd, "_gcd"},
    {&equate_oe_copy, "copy"},
...
struct OPS *record_anys_left_right_ops __CLU_COMMON;
struct OPS *sequence_of_equate_ops __CLU_COMMON;
...
struct OPS *sequence_of_record_body_line_names_vars_ops __CLU_COMMON;
struct OPS *oneof_decl_none_ops __CLU_COMMON;
extern struct OPS *oneof_decl_none_ops;
struct OPS *record_body_decl_line_ops __CLU_COMMON;
extern struct OPS *record_body_decl_line_ops;
struct OPS *oneof_arm_none_ops __CLU_COMMON;
extern struct OPS *sequence_of_record_body_line_names_vars_ops;
extern struct OPS *oneof_arm_none_ops;
struct OPS *record_arms_others__stmt_ops __CLU_COMMON;
struct OPS *record_args_name_ops __CLU_COMMON;
struct OPS *record_apply_args_ops __CLU_COMMON;
struct OPS *oneof_new_old_ops __CLU_COMMON;
extern struct OPS *record_apply_args_ops;
extern struct OPS *oneof_new_old_ops;
extern struct OPS *bool_ops;
struct OPS *record_anys_body_call_vars_xent_ops __CLU_COMMON;
struct OPS *record_name_parms_type__ops __CLU_COMMON;
struct OPS *sequence_of_record_name_parms_type__ops __CLU_COMMON;
struct OPS *record_line_opers_ops __CLU_COMMON;
struct OPS *sequence_of_record_line_opers_ops __CLU_COMMON;
...
struct OPS *record_expr_type__val_where__ops __CLU_COMMON;
struct OPS *record_body_line_test_ops __CLU_COMMON;
extern struct OPS *record_body_line_test_ops;
struct OPS *sequence_of_record_body_line_test_ops __CLU_COMMON;
struct OPS *oneof_body_none_ops __CLU_COMMON;
extern struct OPS *sequence_of_record_body_line_test_ops;
extern struct OPS *oneof_body_none_ops;
struct OPS *record_arms_else__ops __CLU_COMMON;
struct OPS *record_resigs_stmt_ops __CLU_COMMON;
struct OPS *record_left_right_ops __CLU_COMMON;
struct OPS *record_body_line_tags_var_ops __CLU_COMMON;
extern struct OPS *record_body_line_tags_var_ops;
struct OPS *sequence_of_record_body_line_tags_var_ops __CLU_COMMON;
extern struct OPS *sequence_of_record_body_line_tags_var_ops;
struct OPS *record_arms_obj_others__ops __CLU_COMMON;
struct OPS *record_body_test_ops __CLU_COMMON;
...
struct OPS *oneof_assn_bad_body_break__continue__decl_declinit_except__exit__for__force__if__invoke_resignal__return__signal__sugarassn_tag__while__yield__ops __CLU_COMMON;
...
struct OPS *record_line_stmt_1_ops __CLU_COMMON;
static int stmt_own_init = 0;
const OWN_req stmt_ownreqs = { 0, 0 };

errcode
stmt_own_init_proc(void)
{
    errcode err;
    enter_own_init_proc();
    if (stmt_own_init == 0) {
        ...
        add_selector_info("left", 1, (struct OPS *)sequence_of_idn_ops);
        add_selector_info("right", 2, (struct OPS *)sequence_of_expr_ops);
        ...
        add_parm_info_type(0, (const struct OPS *)record_body_line_names_vars_ops, sequence_of_t_reqs);
        ...
        add_selector_info("body", 0, (struct OPS *)record_equates_stmts_ops);
        add_selector_info("decl", 1, (struct OPS *)oneof_decl_none_ops);
        add_selector_info("line", 2, (struct OPS *)int_ops);
        find_selector_ops("record", 3, &(record_body_decl_line_ops));
        add_selector_info("arm", 0, (struct OPS *)record_body_decl_line_ops);
        add_selector_info("none", 1, (struct OPS *)null_ops);
        find_selector_ops("oneof", 2, &(oneof_arm_none_ops));
        add_selector_info("arms", 0, (struct OPS *)sequence_of_record_body_line_names_vars_ops);
        add_selector_info("others_", 1, (struct OPS *)oneof_arm_none_ops);
        add_selector_info("stmt", 2, (struct OPS *)stmt_ops);
        find_selector_ops("record", 3, &(record_arms_others__stmt_ops));
        add_selector_info("args", 0, (struct OPS *)sequence_of_expr_ops);
        ...
        add_selector_info("new", 0, (struct OPS *)sequence_of_record_idns_type__ops);
        add_selector_info("old", 1, (struct OPS *)sequence_of_idn_ops);
        find_selector_ops("oneof", 2, &(oneof_new_old_ops));
        add_selector_info("anys", 0, (struct OPS *)sequence_of_record_idns_type__ops);
        add_selector_info("body", 1, (struct OPS *)record_equates_stmts_ops);
        add_selector_info("call", 2, (struct OPS *)record_apply_args_ops);
        add_selector_info("vars", 3, (struct OPS *)oneof_new_old_ops);
        add_selector_info("xent", 4, (struct OPS *)bool_ops);
        ...
        add_selector_info("type_", 1, (struct OPS *)idn_ops);
        add_selector_info("val", 2, (struct OPS *)idn_ops);
        add_selector_info("where_", 3, (struct OPS *)sequence_of_record_idn_kind_line_ops);
        find_selector_ops("record", 4, &(record_expr_type__val_where__ops));
        add_selector_info("body", 0, (struct OPS *)record_equates_stmts_ops);
        add_selector_info("line", 1, (struct OPS *)int_ops);
        add_selector_info("test", 2, (struct OPS *)expr_ops);
        find_selector_ops("record", 3, &(record_body_line_test_ops));
        add_parm_info_type(0, (const struct OPS *)record_body_line_test_ops, sequence_of_t_reqs);
        ...
        add_selector_info("arms", 0, (struct OPS *)sequence_of_record_body_line_test_ops);
        add_selector_info("else_", 1, (struct OPS *)oneof_body_none_ops);
        find_selector_ops("record", 2, &(record_arms_else__ops));
        add_selector_info("resigs", 0, (struct OPS *)sequence_of_string_ops);
        add_selector_info("stmt", 1, (struct OPS *)stmt_ops);
        ...
        add_selector_info("body", 0, (struct OPS *)record_equates_stmts_ops);
        add_selector_info("line", 1, (struct OPS *)int_ops);
        add_selector_info("tags", 2, (struct OPS *)sequence_of_string_ops);
        add_selector_info("var", 3, (struct OPS *)oneof_decl_none_ops);
        find_selector_ops("record", 4, &(record_body_line_tags_var_ops));
        add_parm_info_type(0, (const struct OPS *)record_body_line_tags_var_ops, sequence_of_t_reqs);
        find_type_instance(sequence_ops, 1, &sequence_ownreqs, &(sequence_of_record_body_line_tags_var_ops));
        add_selector_info("arms", 0, (struct OPS *)sequence_of_record_body_line_tags_var_ops);
        add_selector_info("obj", 1, (struct OPS *)expr_ops);
        add_selector_info("others_", 2, (struct OPS *)oneof_body_none_ops);
        find_selector_ops("record", 3, &(record_arms_obj_others__ops));
        add_selector_info("body", 0, (struct OPS *)record_equates_stmts_ops);
        add_selector_info("test", 1, (struct OPS *)expr_ops);
        find_selector_ops("record", 2, &(record_body_test_ops));
        add_selector_info("assn", 0, (struct OPS *)record_anys_left_right_ops);
        add_selector_info("bad", 1, (struct OPS *)null_ops);
        add_selector_info("body", 2, (struct OPS *)record_equates_stmts_ops);
        add_selector_info("break_", 3, (struct OPS *)null_ops);
        add_selector_info("continue_", 4, (struct OPS *)null_ops);
        add_selector_info("decl", 5, (struct OPS *)record_idns_type__ops);
        add_selector_info("declinit", 6, (struct OPS *)record_anys_decls_expr_ops);
        add_selector_info("except_", 7, (struct OPS *)record_arms_others__stmt_ops);
        add_selector_info("exit_", 8, (struct OPS *)record_args_name_ops);
        add_selector_info("for_", 9, (struct OPS *)record_anys_body_call_vars_xent_ops);
        add_selector_info("force_", 10, (struct OPS *)record_expr_type__val_where__ops);
        add_selector_info("if_", 11, (struct OPS *)record_arms_else__ops);
        add_selector_info("invoke", 12, (struct OPS *)record_apply_args_ops);
        add_selector_info("resignal_", 13, (struct OPS *)record_resigs_stmt_ops);
        add_selector_info("return_", 14, (struct OPS *)sequence_of_expr_ops);
        add_selector_info("signal_", 15, (struct OPS *)record_args_name_ops);
        add_selector_info("sugarassn", 16, (struct OPS *)record_left_right_ops);
        add_selector_info("tag_", 17, (struct OPS *)record_arms_obj_others__ops);
        add_selector_info("while_", 18, (struct OPS *)record_body_test_ops);
        add_selector_info("yield_", 19, (struct OPS *)sequence_of_expr_ops);
        ...
        add_selector_info("line", 0, (struct OPS *)int_ops);
        add_selector_info("stmt", 1, (struct OPS *)oneof_assn_bad_body_break__continue__decl_declinit_except__exit__for__force__if__invoke_resignal__return__signal__sugarassn_tag__while__yield__ops);
...
static CLU_proc stmt_oe__gcd = { .proc = stmtOP_gcd };
static CLU_proc stmt_oe_copy = { .proc = stmtOPcopy };
static CLU_proc stmt_oe_create = { .proc = stmtOPcreate };
static CLU_proc stmt_oe_equal = { .proc = stmtOPequal };
static CLU_proc stmt_oe_get_abs = { .proc = stmtOPget_abs };
static CLU_proc stmt_oe_get_line = { .proc = stmtOPget_line };
static CLU_proc stmt_oe_set_abs = { .proc = stmtOPset_abs };
static CLU_proc stmt_oe_similar = { .proc = stmtOPsimilar };

static stmt_OPS stmt_ops_actual = {8, (OWNPTR)&stmt_own_init, (OWNPTR)&stmt_own_init, {
    {&stmt_oe__gcd, "_gcd"},
    {&stmt_oe_copy, "copy"},
...
struct OPS *record_expr_type__ops __CLU_COMMON;
static int expr_own_init = 0;
const OWN_req expr_ownreqs = { 0, 0 };

errcode
expr_own_init_proc(void)
{
    errcode err;
    enter_own_init_proc();
    if (expr_own_init == 0) {
        ...
        add_selector_info("expr", 0, (struct OPS *)oneof_a_cons_any__apply_bad_bool__cand__char__cor__down__fetch_force__get_idn_infix_int__invoke_minus_not_null__op_real__ref_s_cons_str_type__type_of__up__ops);
        add_selector_info("type_", 1, (struct OPS *)typespec_ops);
...
static CLU_proc expr_oe__gcd = { .proc = exprOP_gcd };
static CLU_proc expr_oe_copy = { .proc = exprOPcopy };
static CLU_proc expr_oe_create = { .proc = exprOPcreate };
static CLU_proc expr_oe_equal = { .proc = exprOPequal };
static CLU_proc expr_oe_get_abs = { .proc = exprOPget_abs };
static CLU_proc expr_oe_get_typespec = { .proc = exprOPget_typespec };
static CLU_proc expr_oe_set_abs = { .proc = exprOPset_abs };
static CLU_proc expr_oe_set_typespec = { .proc = exprOPset_typespec };
static CLU_proc expr_oe_similar = { .proc = exprOPsimilar };

static expr_OPS expr_ops_actual = {9, (OWNPTR)&expr_own_init, (OWNPTR)&expr_own_init, {
    {&expr_oe__gcd, "_gcd"},
    {&expr_oe_copy, "copy"},
