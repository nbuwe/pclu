...
p_applytype(CLUREF e, CLUREF gen, CLUREF *ret_1)
{
  ...
  LINE(61);
    ...
    CUR_PROC_VAR.proc = &generic_CLU_proc;
    err = p_plist(e, T_1_1, CLU_false, CLU_true, STR_typespec, &T_1_2);
    if (err != ERR_ok)
        goto ex_0;
    args.num = T_1_2.num;
    }
...
p_values(CLUREF e, CLUREF procdef, CLUREF *ret_1)
{
  ...
  LINE(159);
    ...
    generic_CLU_proc.proc = p_plist;
    CUR_PROC_VAR.proc = &generic_CLU_proc;
    err = p_plist(e, T_1_1, CLU_false, CLU_false, STR_typespec, &T_1_2);
    if (err != ERR_ok)
        goto ex_0;
    ret_1->num = T_1_2.num;
    }
...
p_exception(CLUREF e, errcode (*proc)(), void *user_locals, errcode *iecode)
{
  ...
  LINE(198);
    ...
    generic_CLU_proc.proc = p_plist;
    CUR_PROC_VAR.proc = &generic_CLU_proc;
    err = p_plist(e, T_1_1, CLU_true, CLU_false, STR_typespec, &T_1_2);
    if (err != ERR_ok)
        goto ex_0;
    types.num = T_1_2.num;
    }
...
p_order_IB_1(CLUREF iv_1, p_order_LOCALS_t *locals, errcode *iecode)
{
  ...
  FB_LINE(231);
    for (;;) { /* while */
        ...
        CLUREF T_1_4;
        CLUREF T_1_5;
        T_1_2.num = (locals->i.num <= locals->high.num);
        T_1_1.num = T_1_2.num;
        if (T_1_2.num) {
  ...
  FB_LINE(234);
    { /* if */
    CLUREF T_1_1;
    T_1_1.num = (locals->i.num <= locals->high.num);
