...
} stable_of_value_t_reqs_actual = {
    1, {
        { "unparse" },
    }
};

const struct REQS * const stable_of_value_t_reqs
    = (const struct REQS *)&stable_of_value_t_reqs_actual;
...
stableOPcompletions_IB_1(CLUREF iv_1, CLUREF iv_2, stableOPcompletions_LOCALS_t *locals, errcode *iecode)
{
  ...
  FB_LINE(35);
    ...
    T_1_1.num = ((locals->key.str->size != locals->name.str->size)? false :
        !(memcmp(locals->key.str->data, locals->name.str->data, locals->key.str->size)));
  ...
  LINE(48);
    for (;;) { /* while */
        ...
        T_2_4.num = ((T_2_3.str->size != ms.str->size)? false :
            !(memcmp(T_2_3.str->data, ms.str->data, T_2_3.str->size)));
        if (T_2_4.num != true)
            break;
...
stableOPinsert(CLUREF tbl, CLUREF name, CLUREF val)
{
  ...
  LINE(58);
    ...
    T_2_3.num = ((T_2_2.str->size != name.str->size)? false :
        !(memcmp(T_2_2.str->data, name.str->data, T_2_2.str->size)));
...
stableOPempty(CLUREF tbl, CLUREF *ret_1)
{
  ...
  LINE(143);
    ...
    {
    CLUREF T_1_1;
    T_1_1.num = (tbl.array->ext_size == 0);
    ret_1->num = T_1_1.num;
    }
    signal (ERR_ok);
    }
...
typedef struct {
    ...
    CLUREF value;
    CLUREF tbl;
} stableOPunparse_LOCALS_t;

errcode
stableOPunparse(CLUREF tbl, CLUREF *ret_1)
{
    stableOPunparse_LOCALS_t locals;
    locals.tbl = tbl;
    locals.type_own_ptr = (stable_OWN_DEFN *) CUR_PROC_VAR.proc->type_owns;
