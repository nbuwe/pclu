...
c_stmt(CLUREF e, CLUREF s)
{
  ...
  LINE(27);
        {
        CLUREF T_2_1;
        err = c_invoke(e, sa, CLU_false, &T_2_1);
        if (err != ERR_ok)
            goto ex_0;
        }
        break;
...
c_declinit(CLUREF e, CLUREF di, CLUREF own_vars)
{
  ...
  LINE(81);
        {
        CLUREF T_2_1;
        err = c_invoke(e, xa, CLU_false, &T_2_1);
        if (err != ERR_ok)
            goto ex_0;
        types.num = T_2_1.num;
        }
...
c_assn(CLUREF e, CLUREF sgn)
{
  ...
  LINE(153);
            ...
            CLUREF T_3_1;
            CLUREF T_3_2;
            err = c_invoke(e, xa, CLU_false, &T_3_1);
            if (err != ERR_ok)
                goto ex_0;
...
c_sugarassn(CLUREF e, CLUREF s, CLUREF sa)
{
  ...
  LINE(271);
    {
    CLUREF T_1_1;
    err = c_invoke(e, inv, CLU_true, &T_1_1);
    if (err != ERR_ok)
        goto ex_0;
    }
