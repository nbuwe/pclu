...
lqsort(CLUREF items, CLUREF low, CLUREF high, CLUREF size, CLUREF less)
{
  ...
  LINE(109);
            { /* if */
            CLUREF T_4_1;
            T_4_1.num = (smlsize.num < size.num);
