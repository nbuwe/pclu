...
bigintOPi2bi(CLUREF i, CLUREF *ret_1)
{
  ...
  LINE(22);
            ...
            {
            CLUREF T_3_1;
            err = arrayOPfill(CLU_1, CLU_1, i, &T_3_1);
            if (err != ERR_ok)
                goto ex_0;
            ret_1->num = T_3_1.num;
            }
  ...
  LINE(24);
            ...
            CLUREF T_3_4;
            CLUREF T_3_5;
            err = arrayOPpredict(CLU_1, CLU_2, &T_3_1);
            if (err != ERR_ok)
                goto ex_0;
            T_3_2.num = 268435456;
  ...
  LINE(29);
            ...
            {
            CLUREF T_3_1;
            err = arrayOPfill(CLU_1, CLU_1, first, &T_3_1);
            if (err != ERR_ok)
                goto ex_0;
            ret_1->num = T_3_1.num;
            }
...
bigintOPparse(CLUREF a, CLUREF *ret_1)
{
  ...
  LINE(57);
    {
    CLUREF T_1_1;
    err = arrayOPfill(CLU_1, CLU_1, CLU_0, &T_1_1);
    if (err != ERR_ok)
        goto ex_0;
    psum.num = T_1_1.num;
    }
  ...
  LINE(58);
    {
    CLUREF T_1_1;
    err = arrayOPfill(CLU_1, CLU_1, CLU_10, &T_1_1);
    if (err != ERR_ok)
        goto ex_0;
    ten.num = T_1_1.num;
    }
...
bigintOPaddsub(CLUREF a, CLUREF b, CLUREF neg, CLUREF *ret_1)
{
  ...
  LINE(148);
        ...
        CLUREF T_2_8;
        T_2_3.num = 134217728;
        T_2_4.num = (fa.num >= T_2_3.num);
        T_2_2.num = T_2_4.num;
        if (T_2_4.num) {
            T_2_5.num = 134217728;
            T_2_6.num = (fb.num >= T_2_5.num);
            T_2_2.num = T_2_6.num;
        }
        T_2_1.num = T_2_2.num;
        if (T_2_2.num) {
            T_2_7.num = 134217728;
            T_2_8.num = (psum.num < T_2_7.num);
            T_2_1.num = T_2_8.num;
        }
        if (T_2_1.num == true) { /* if */
...
bigintOPclear_leads(CLUREF r)
{
  ...
  LINE(330);
            ...
            if (T_4_3.num) {
                ...
                T_4_5.num = 134217728;
                T_4_6.num = (T_4_4.num >= T_4_5.num);
                T_4_2.num = T_4_6.num;
            }
            T_4_1.num = T_4_2.num;
            if (!T_4_2.num) {
                T_4_8.num = 268435455;
                T_4_9.num = (fd.num == T_4_8.num);
                T_4_7.num = T_4_9.num;
                if (T_4_9.num) {
                    if (rsz.num < r.array->ext_low || rsz.num > r.array->ext_high) {
                        err = ERR_bounds;
                    ...
                    T_4_12.num = (T_4_10.num < T_4_11.num);
...
bigintOPpower(CLUREF a, CLUREF b, CLUREF *ret_1)
{
  ...
  LINE(347);
    {
    CLUREF T_1_1;
    err = arrayOPfill(CLU_1, CLU_1, CLU_1, &T_1_1);
    if (err != ERR_ok)
        goto ex_0;
    sexp.num = T_1_1.num;
    }
...
bigintOPdiv(CLUREF a, CLUREF b, CLUREF *ret_1)
{
  ...
  LINE(367);
        ...
        CLUREF T_2_1;
        CLUREF T_2_2;
        err = arrayOPfill(CLU_1, CLU_1, CLU_1, &T_2_1);
        if (err != ERR_ok)
            goto ex_0;
...
bigintOPdivmod(CLUREF a, CLUREF b, CLUREF *ret_1, CLUREF *ret_2)
{
  ...
  LINE(418);
        ...
        {
        CLUREF T_2_1;
        err = arrayOPfill(CLU_1, CLU_1, remainder, &T_2_1);
        if (err != ERR_ok)
            goto ex_0;
        ret_2->num = T_2_1.num;
        }
  ...
  LINE(422);
        ...
        {
        CLUREF T_2_1;
        err = arrayOPfill(CLU_1, CLU_1, CLU_0, &T_2_1);
        if (err != ERR_ok)
            goto ex_0;
        ret_1->num = T_2_1.num;
        }
  ...
  LINE(424);
    ...
    if ((newba.array->int_low + newba.array->ext_size + 1) < newba.array->int_size) {
        ...
        newba.array->ext_size++;
        newba.array->ext_high++;
    }
    else {
