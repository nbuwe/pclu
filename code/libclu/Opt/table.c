...
tableOPcreate(CLUREF size, CLUREF hasher, CLUREF comper, CLUREF *ret_1)
{
  ...
  LINE(46);
    ...
    CLUREF T_1_2;
    T_1_1.num = (long)nil;
    T_1_2.num = (type_own_ptr->unique.num == T_1_1.num);
...
tableOPbind(CLUREF t, CLUREF k, CLUREF v)
{
  ...
  LINE(121);
    ...
    T_1_6.num = (T_1_5.num == type_own_ptr->unique.num);
    T_1_7.num = !T_1_6.num;
...
tableOPlookup(CLUREF t, CLUREF k, CLUREF *ret_1)
{
  ...
  LINE(197);
        ...
        CLUREF T_2_2;
        T_2_1.num = t.vec->data[5];
        T_2_2.num = (T_2_1.num == type_own_ptr->unique.num);
        if (T_2_2.num == true) { /* if */
...
tableOPrehash(CLUREF t, CLUREF hasher)
{
  ...
  LINE(351);
        ...
        CLUREF T_2_2;
        T_2_1.num = (long)nil;
        T_2_2.num = (nchain.num == T_2_1.num);
        if (T_2_2.num == true) { /* if */
