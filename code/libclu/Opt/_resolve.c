...
_resolveOPinit(CLUREF *ret_1)
{
  ...
  LINE(67);
    { /* if */
    CLUREF T_1_1;
    T_1_1.num = (_resolveOPpkid.num < 0);
...
_resolveOPnstore(CLUREF dname, CLUREF idx, CLUREF max, CLUREF *ret_1)
{
  ...
  LINE(221);
        ...
        CLUREF T_2_2;
        CLUREF T_2_3;
        T_2_2.num = (idx.num == zidx.num);
        T_2_1.num = T_2_2.num;
        if (T_2_2.num) {
            T_2_3.num = (i.num > z.num);
            T_2_1.num = T_2_3.num;
        }
        if (T_2_1.num == true) { /* if */
