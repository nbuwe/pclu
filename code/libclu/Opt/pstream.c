...
pstreamOPputs_IB_1(CLUREF iv_1, pstreamOPputs_LOCALS_t *locals, errcode *iecode)
{
  ...
  FB_LINE(203);
    ...
    CLUREF T_1_2;
    T_1_1.ch = '\n';
    T_1_2.num = (locals->c.ch == T_1_1.ch);
    if (T_1_2.num == true) { /* if */
