...
gcd_storeOPstore_string(CLUREF s)
{
  ...
  LINE(497);
        { /* if */
        CLUREF T_3_1;
        T_3_1.num = (total_output.num == total_longs.num);
        if (T_3_1.num == true) { /* if */
            { /* exit */
                err = ((errcode)"ERR_done");
                goto ex_1;
            }
        }
        } /* end if */
...
gcd_storeOPneed(CLUREF i, CLUREF *ret_1)
{
  ...
  LINE(510);
    ...
    if (err != ERR_ok)
        goto ex_0;
    T_1_4.num = (T_1_3.num <= gcd_storeOPbpagesz.num);
  ...
  LINE(520);
        ...
        CLUREF T_2_2;
        T_2_1.num = 1024;
        T_2_2.num = (gcd_storeOPpos.num <= T_2_1.num);
