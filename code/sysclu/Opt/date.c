...
dateOPcreate(CLUREF day, CLUREF month, CLUREF year, CLUREF hour, CLUREF minute, CLUREF second, CLUREF *ret_1)
{
  ...
  LINE(30);
    ...
    CLUREF T_1_22;
    CLUREF T_1_23;
    T_1_11.num = (day.num < 1);
    T_1_10.num = T_1_11.num;
    if (!T_1_11.num) {
        T_1_12.num = (day.num > 31);
        T_1_10.num = T_1_12.num;
    }
    T_1_9.num = T_1_10.num;
    if (!T_1_10.num) {
        T_1_13.num = (month.num < 1);
        T_1_9.num = T_1_13.num;
    }
    T_1_8.num = T_1_9.num;
    if (!T_1_9.num) {
        T_1_14.num = (month.num > 12);
        T_1_8.num = T_1_14.num;
    }
    T_1_7.num = T_1_8.num;
    if (!T_1_8.num) {
        T_1_15.num = (year.num < 1);
        T_1_7.num = T_1_15.num;
    }
    T_1_6.num = T_1_7.num;
    if (!T_1_7.num) {
        T_1_16.num = (hour.num < 0);
        T_1_6.num = T_1_16.num;
    }
    T_1_5.num = T_1_6.num;
    if (!T_1_6.num) {
        T_1_17.num = (hour.num > 23);
        T_1_5.num = T_1_17.num;
    }
    T_1_4.num = T_1_5.num;
    if (!T_1_5.num) {
        T_1_18.num = (minute.num < 0);
        T_1_4.num = T_1_18.num;
    }
    T_1_3.num = T_1_4.num;
    if (!T_1_4.num) {
        T_1_19.num = 59;
        T_1_20.num = (minute.num > T_1_19.num);
        T_1_3.num = T_1_20.num;
    }
    T_1_2.num = T_1_3.num;
    if (!T_1_3.num) {
        T_1_21.num = (second.num < 0);
        T_1_2.num = T_1_21.num;
    }
    T_1_1.num = T_1_2.num;
    if (!T_1_2.num) {
        T_1_22.num = 59;
        T_1_23.num = (second.num > T_1_22.num);
